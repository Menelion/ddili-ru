...
$(P
The $(C is) $(I expression) is unrelated to the $(C is) $(I operator) that we have seen in $(LINK2 /ders/d.en/null_is.html, The $(CH4 null) Value and the $(CH4 is) Operator chapter), both syntactically and semantically:
)
