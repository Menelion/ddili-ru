...
$(P
$(I $(B Note:) dmd 2.069, the compiler that was used to compile the examples in this chapter, did not fully support this feature yet. For that reason, some of the examples below use only fixed-length arrays.)
)
