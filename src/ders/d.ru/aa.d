...
$(P
It is possible to remove all of the key-value pairs at once, as will be seen in the first exercise below.
)
...
$(LI $(IX .length) $(C .length) returns the number of key-value pairs in the associative array.)

$(LI $(IX .keys) $(C .keys) returns a copy of all of the keys in the associative array as a dynamic array.)

$(LI $(IX .byKey) $(C .byKey) provides access to the keys in the associative array without copying them; we will see how $(C .byKey) is used in $(C foreach) loops in the next chapter.)

$(LI $(IX .values) $(C .values) returns a copy of all of the values in the associative array as a dynamic array.)

$(LI $(IX .byValue) $(C .byValue) provides access to the values of the associative array without copying them.)

$(LI $(IX .byKeyValue) $(C .byKeyValue) provides access to the key-value pairs in the associative array without copying them.)
...
$(LI $(IX .remove) $(C .remove) removes the specified key-value pair from the array.)
...
$(PROBLEM
How can all of the key-value pairs of an associative array be removed? There are at least three methods:
