...
void func(int parameter) {
    writefln("Inside function %s at file %s, line %s.",
             __FUNCTION__, __FILE__, __LINE__);    $(CODE_NOTE $(HILITE line 6))
}
...
$(P
The reported line 6 is inside the function:
)

$(SHELL
Inside function deneme.$(HILITE func) at file deneme.d, $(HILITE line 6).
)
...
$(SHELL
Called from function deneme.$(HILITE main) at file deneme.d, $(HILITE line 14).
)
