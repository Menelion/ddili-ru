...
$(LI
"There is a bicycle for everyone" can be coded as $(C personCount <= bicycleCount) or $(C bicycleCount >= personCount). The rest of the logical expression can directly be translated to program code from the exercise:
...
Macros:
        ...
        DESCRIPTION=Programming in D exercise solutions: logical expressions

        KEYWORDS=programming in d tutorial logical expressions
