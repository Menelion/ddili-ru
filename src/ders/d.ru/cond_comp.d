...
$(P
The compilation is aborted by the message that was given to $(C static assert):
)
...
$(P
If the function was called with a $(C char), the compilation would be aborted by the following error message:
)
...
$(LI
$(C static assert) valides assumptions about code at compile time.
)
