...
$(P
All of the operators above have assignment counterparts: $(C ~=), $(C &=), $(C |=), $(C ^=), $(C >>=), $(C >>>=), and $(C <<=).
)

$(P
Similar to the operators that we have seen in $(LINK2 /ders/d.en/operator_overloading.html, the Operator Overloading chapter), these operators assign the result back to the left-hand operand.
)
