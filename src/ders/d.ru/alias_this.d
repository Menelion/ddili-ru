...
$(P
$(HILITE $(I $(B Note:) dmd 2.069, the compiler that was used last to compile the examples in this chapter, allowed only one $(C alias this) declaration.))
)
...
class TeachingAssistant {
     ...
     *
     * Note: dmd 2.069 did not support multiple 'alias this'
     *       declarations. */
